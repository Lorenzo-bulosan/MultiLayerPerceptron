...
class TestPerceptronFeedforward:
    ...
    class TestSigmoid:
        def test_positive_preactivation(self):
            ...
            p = Perceptron(inputs, weights, -4.0, ActivationTypeIds.SIGMOID)
            result = p.feedforward()
        ...
        def test_zero_value_preactivation(self):
            ...
            p = Perceptron(inputs, weights, 0.0, ActivationTypeIds.SIGMOID)
            result = p.feedforward()
    ...
    class TestRelu:
        def test_relu_positive(self):
            ...
            inputs = np.array([2.0])
            weights = np.array([1.0])
            p = Perceptron(inputs, weights, 0.0, ActivationTypeIds.RELU)
            result = p.feedforward()
            assert result == 2.0
    ...
    class TestLeakyRelu:
        def test_leaky_relu_positive(self):
            ...
            inputs = np.array([2.0])
            weights = np.array([1.0])
            p = Perceptron(inputs, weights, 0.0, ActivationTypeIds.LEAKY_RELU)
            result = p.feedforward()
            assert result == 2.0
    ...
    class TestTanh:
        def test_positive_preactivation(self):
            ...
            inputs = np.array([1.0])
            weights = np.array([1.0])
            p = Perceptron(inputs, weights, 0.0, ActivationTypeIds.TANH)
            result = p.feedforward()
